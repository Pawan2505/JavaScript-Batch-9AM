...
Using backticks (`\) within .innerTextwill display the tags as plain text, whereas using them within.innerHTML` interprets them as HTML tags, creating italicized text.
